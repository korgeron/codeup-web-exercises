...
//     console.log(person.sayHello);
  ...
  //         let d = shopper.amount * 0.12;
  //         let e = shopper.amount - d;
  //         let totalDiscounted = shopper.name + '(s) total of $' + shopper.amount +  ' with a $' + d + ' discount = ' + '$' + e;
  //         console.log(totalDiscounted);
  //     } else {
  //         let dis = 0;
  //         let noDiscount =  shopper.name + '(s) total of $' + shopper.amount +  ' with a $' + dis + ' discount = ' + '$' + shopper.amount;
